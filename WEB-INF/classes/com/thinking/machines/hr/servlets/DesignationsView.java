...
pw.println("<div style='height:65vh;margin:5px;float:left;padding:5px;border:2px solid black'>");
...
pw.println("<div style='height:65vh;margin-left:105px;margin-right:5px;margin-bottom-5px;margin-top:5px;padding:5px;overflow:scroll;border:2px solid black'>");
...
pw.println("<div style='width:90hw;height:auto;margin:5px;text-align:center;border:2px solid white'>");
