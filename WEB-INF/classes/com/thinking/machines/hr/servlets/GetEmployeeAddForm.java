...
pw.println("<td>");
pw.println("<input type='text' style='text-align:right' name='basicSalary' id='basicSalary'>");
...
pw.println("<td>");
pw.println("<input type='text' name='panNumber' id='panNumber'maxlength='15' size='16'>");
...
pw.println("<td>");
pw.println("<input type='text' name='aadharCardNumber' id='aadharCardNumber'maxlength='15' size='16'>");
